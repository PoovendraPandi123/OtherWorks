...
def medical_insurance_no_insurance():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/september-2022/18102022/data_sept_2022_proper.xlsx")

        classification = Classification()

        data_no_insurance = classification.no_insurance(data_frame=data)

        if get_write_file(data_frame=data_no_insurance, file_name="med_ins_sept_2022_data_no_insurance.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_prior_to_policy():
    try:
        ...
        if get_write_file(data_frame=data_ptp, file_name="med_ins_sept_2022_data_ptp.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_live():
    try:
        ...
        if len(data_live) > 0:
            ...
            if get_write_file(data_frame=data_live, file_name="med_ins_sept_2022_data_live.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_deletion():
    try:
        ...
        data_deletion = classification.deletion(data_frame=data, inception_data_frame=inception_data, upload_month=9, upload_year=2022)

        if get_write_file(data_frame=data_deletion, file_name="med_ins_sept_2022_data_deletion.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_addition_and_deletion():
    try:
        ...
        if get_write_file(data_frame=data_addition_and_deletion, file_name="med_ins_sept_2022_data_addition_and_deletion.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_already_deletion():
    try:
        ...
        if get_write_file(data_frame=data_already_deletion, file_name="med_ins_sept_2022_data_already_deletion.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_addition():
    try:
        ...
        if get_write_file(data_frame=data_addition, file_name="med_ins_sept_2022_data_addition.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_reactivation():
    try:
        ...
        if get_write_file(data_frame=data_reactivation, file_name="med_ins_sept_2022_data_reactivation.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_next_month_addition():
    try:
        ...
        excel_write_folder_location = "H:/Testing/Medical Insurance/A-Testing/Medical Insurance/september-2022/18102022"
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/september-2022/18102022/med_ins_sept_2022_data_reactivation.xlsx")

        classification = Classification()

        data_next_month_addition = classification.next_month_addition(data_frame=data, upload_month=9, upload_year=2022)

        if get_write_file(data_frame=data_next_month_addition, file_name="med_ins_sept_2022_data_next_month_addition.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_next_month_deletion():
    try:
        ...
        data_next_month_deletion = classification.next_month_deletion(data_frame=data, inception_data_frame=inception_data, upload_month=9, upload_year=2022)

        if get_write_file(data_frame=data_next_month_deletion, file_name="med_ins_sept_2022_data_next_month_deletion.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_alcs_deletion():
    try:
        ...
        data_alcs_deletion = classification.alcs_deletion(data_frame=data, upload_month=9, upload_year=2022)

        if get_write_file(data_frame=data_alcs_deletion, file_name="med_ins_sept_2022_data_alcs_deletion.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_next_month_alcs_deletion():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/september-2022/18102022/med_ins_sept_2022_data_alcs_deletion.xlsx")

        classification = Classification()

        data_next_month_alcs_deletion = classification.next_month_alcs_deletion(data_frame=data, upload_month=9, upload_year=2022)

        if get_write_file(data_frame=data_next_month_alcs_deletion, file_name="med_ins_sept_2022_data_next_month_alcs_deletion.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_migration_addition():
    try:
        ...
        if get_write_file(data_frame=data_migration_addition, file_name="med_ins_sept_2022_data_migration_addition.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_death():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/september-2022/18102022/med_ins_sept_2022_data_migration_addition.xlsx")

        classification = Classification()

        data_death = classification.death(data_frame=data)

        if get_write_file(data_frame=data_death, file_name="med_ins_sept_2022_data_death.xlsx", folder_location=excel_write_folder_location):
...
def medical_insurance_policy_type():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/september-2022/18102022/med_ins_sept_2022_data_death.xlsx")

        classification = Classification()

        data_policy_type = classification.policy_type(data_frame=data)

        if get_write_file(data_frame=data_policy_type, file_name="med_ins_sept_2022_data_policy_type.xlsx", folder_location=excel_write_folder_location):
