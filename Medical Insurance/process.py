...
def get_proper_data_required():
    try:

        excel_write_folder_location = "H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022"

        # Read Data and filter only United Insurance, Read Inception Data and Update Status and Policy Type

        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/data_aug_2022.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_united_aug_2022.xlsx")
        ...
        inception_data["Status"] = inception_data.apply(
            lambda x : 'InActive' if x['Classification'] in ["Deletion", "ALCS Deletion"] else 'Active', axis = 1
        )
        ...
        if get_write_file(data_frame=data_required, file_name="data_aug_2022_proper.xlsx", folder_location=excel_write_folder_location):
            print("Data Written Successfully!!!")
        else:
            print("Error in Writing Data!!!")

        if get_write_file(data_frame=inception_data, file_name="inception_july_2022_united.xlsx", folder_location=excel_write_folder_location):
        ...
        print(e)
        logging.error("Error in Get Proper Data Required Function!!!", exc_info=True)
...
def medical_insurance_no_insurance():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/data_aug_2022_proper.xlsx")
...
def medical_insurance_prior_to_policy():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_no_insurance.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_live():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_ptp.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_deletion():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_live.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_addition_and_deletion():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_deletion.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_already_deletion():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_addition_and_deletion.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_addition():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_already_deletion.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_reactivation():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_addition.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_next_month_addition():
    try:
        ...
        excel_write_folder_location = "H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022"
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_reactivation.xlsx")
...
def medical_insurance_next_month_deletion():
    try:
        excel_write_folder_location = "H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022"
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_next_month_addition.xlsx")
...
def medical_insurance_alcs_deletion():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_next_month_deletion.xlsx")
...
def medical_insurance_next_month_alcs_deletion():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_alcs_deletion.xlsx")
...
def medical_insurance_migration_addition():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_next_month_alcs_deletion.xlsx")
        inception_data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/inception_july_2022_united.xlsx")
...
def medical_insurance_death():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_migration_addition.xlsx")
...
def medical_insurance_policy_type():
    try:
        ...
        data = get_read_proper_data(file_location="H:/Testing/Medical Insurance/A-Testing/Medical Insurance/august-2022/06102022/med_ins_aug_22_data_death.xlsx")
