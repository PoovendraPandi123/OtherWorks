...
class Execution:
    ...
    def __init__(self):
        ...
        # salary_register_file_path = excel_write_folder_location + "/" + "salary_register_sept_2022_proper.xlsx"
        # associate_data_file_path = excel_write_folder_location + "/" + "associate_data_sept_2022_proper.xlsx"
        #
        ...
        # associate_merged_sales_file_path = excel_write_folder_location + "/" + "associate_added_sales_sept_2022.xlsx"
        # mis_file_path = excel_write_folder_location + "/" + "mis_sept_2022_proper.xlsx"
        #
        ...
        # associate_merged_sales_merged_mis_data_path = excel_write_folder_location + "/" + "associate_merged_sales_merged_mis_data_sept_2022.xlsx"
        #
        ...
        # data_path = excel_write_folder_location + "/" + "associate_merged_sales_merged_mis_data_united_sept_2022.xlsx"
        # death_tracker_path = excel_write_folder_location + "/" + "death_report_sept_2022_proper.xlsx"
        #
        ...
        # Rename Columns
        # data_path = excel_write_folder_location + "/" + "associate_data_united_proper_sept_2022.xlsx"
        #
        ...
        # data_path = excel_write_folder_location + "/" + "associate_data_for_process_sept_2022.xlsx"
        #
        ...
        # data_path = excel_write_folder_location + "/" + "data_date_validated_sept_2022.xlsx"
        #
